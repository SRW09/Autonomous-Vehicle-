...
url = 'http://192.168.4.2:8080/video' #Replace with your own video url and add /video to the link
...
def show_live_camera_feed():
    ...
    # Check if the ball is inside the rectangle
        ...
        sock.sendto(response_message.encode("utf-8"), ('192.168.4.1', 12345))  # Send the command to the robot
